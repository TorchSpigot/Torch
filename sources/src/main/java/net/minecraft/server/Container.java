...
public abstract class Container {
    ...
    private int g;
    private final Set<Slot> h = HashObjSets.newMutableSet();
    protected List<ICrafting> listeners = Lists.newArrayList();
    private final Set<EntityHuman> i = HashObjSets.newMutableSet();
    ...
    public NonNullList<ItemStack> a() {
        ...
        for (int i = 0; i < this.c.size(); ++i) {
            nonnulllist.add(this.c.get(i).getItem());
        }
        ...
        if (inventoryclicktype == InventoryClickType.QUICK_CRAFT) {
            ...
            if ((i1 != 1 || this.g != 2) && i1 != this.g) {
                ...
                if (!this.h.isEmpty()) {
                    ...
                    Map<Integer, ItemStack> draggedSlots = HashIntObjMaps.newMutableMap(); // CraftBukkit - Store slots from drag in map (raw slot id -> new stack)
                    ...
                    Map<Integer, org.bukkit.inventory.ItemStack> eventmap = HashIntObjMaps.newMutableMap();
