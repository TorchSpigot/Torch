...
public class BlockRedstoneWire extends Block {
    ...
    private final Set<BlockPosition> B = HashObjSets.newMutableSet(); private final Set<BlockPosition> blocksToUpdate = B; // Paper - OBFHELPER
    ...
    private IBlockData a(World world, BlockPosition blockposition, BlockPosition blockposition1, IBlockData iblockdata) {
        ...
        // CraftBukkit start
        if (i != j) {
            BlockRedstoneEvent event = BlockRedstoneEvent.requestMutable(world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), i, j);
