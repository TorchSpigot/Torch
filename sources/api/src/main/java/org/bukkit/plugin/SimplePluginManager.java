...
public final class SimplePluginManager implements PluginManager {
    ...
    private final Map<Pattern, PluginLoader> fileAssociations = HashObjObjMaps.newMutableMap();
    private final List<Plugin> plugins = new ArrayList<Plugin>();
    private final Map<String, Plugin> lookupNames = HashObjObjMaps.newMutableMap();
    private static File updateDirectory = null;
    private final SimpleCommandMap commandMap;
    private final Map<String, Permission> permissions = HashObjObjMaps.newMutableMap();
    private final Map<Boolean, Set<Permission>> defaultPerms = new LinkedHashMap<Boolean, Set<Permission>>();
    private final Map<String, Map<Permissible, Boolean>> permSubs = HashObjObjMaps.newMutableMap();
    private final Map<Boolean, Map<Permissible, Boolean>> defSubs = HashObjObjMaps.newMutableMap();
    ...
    public SimplePluginManager(Server instance, SimpleCommandMap commandMap) {
        ...
        defaultPerms.put(true, HashObjSets.newMutableSet());
        defaultPerms.put(false, HashObjSets.newMutableSet());
    }
    ...
    public Plugin[] loadPlugins(File directory) {
        ...
        Map<String, File> plugins = HashObjObjMaps.newMutableMap();
        Set<String> loadedPlugins = HashObjSets.newMutableSet();
        Map<String, Collection<String>> dependencies = HashObjObjMaps.newMutableMap();
        Map<String, Collection<String>> softDependencies = HashObjObjMaps.newMutableMap();
